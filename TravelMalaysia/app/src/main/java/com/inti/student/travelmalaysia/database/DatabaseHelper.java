package com.inti.student.travelmalaysia.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_DEST = "destination";
    ...
    public static final String COL_PRICE_ADULT = "price_adult";
    public static final String COL_PRICE_CHILD = "price_child";
    public static final String COL_PRICE_TOTAL = "price_total";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_BOOK + " (" + COL_ID_BOOK + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                COL_LOCATION + " TEXT, " + COL_DEST + " TEXT" + ", " + COL_DATE + " TEXT, " + COL_ADULT + " TEXT, "
                + COL_CHILD + " TEXT)");
        db.execSQL("create table " + TABLE_PRICE + " (" + COL_USERNAME + " TEXT, " + COL_ID_BOOK + " INTEGER, " +
                COL_PRICE_ADULT + " TEXT, " + COL_PRICE_CHILD + " TEXT, " + COL_PRICE_TOTAL +
                " TEXT, FOREIGN KEY(" + COL_USERNAME + ") REFERENCES " + TABLE_USER
                + ", FOREIGN KEY(" + COL_ID_BOOK + ") REFERENCES " + TABLE_BOOK + ")");
        db.execSQL("insert into " + TABLE_USER + " values ('test@gmail.com','test','Test User');");
    }
